  ...
  return (
    <footer className="pt-16 bg-primary">
      <div className="container mx-auto">
        ...
        {/* form */}
        <form className="w-full max-w-3x1 mx-auto flex flex-col md:flex-row md:w-[600px] gap-5 my-14">
          <input
            type="text"
      ...
      <div className="py-10 border-t border-t-white/10">
        <div className="container mx-auto">
          <div className="text-center text-sm text-white/60">Copyright &copy; GearFocus 2023. All rights reserved.</div>
        </div>
      </div>
    </footer>
  );
