...
const ProductDetails = () => {
  ...
  return (
    <div className="mb-16 pt-44 1g:pt-[30px] xl:pt-0 ">
      <div className="container mx-auto ">
        {/* text */}
        <div className="flex flex-col lg:flex-row mb-[30px] ">
          <div className="flex-1 lg:max-w-[40%] lg:h-[540px] rounded-lg flex justify-center items-center bg-bright">
            <img
